    ...
    public void printBeginningMenu() {
        ...
        while(trainer == null){
            switch(StructureService.readChoice("--->  ",new String[]{"1a", "1b", "1c", "2a", "2b", "2c", "3"})){
                case "1a":
                    trainer = loadTrainer(Constants.SAVE_FILE_1);
                    ...
                    break;
                case "1b":
                    trainer = loadTrainer(Constants.SAVE_FILE_2);
                    ...
                    break;
                case "1c":
                    trainer = loadTrainer(Constants.SAVE_FILE_3);
                ...
                case "2a":
                    trainer = new Trainer();
                    saveTrainer(trainer, Constants.SAVE_FILE_1);
                    break;
                case "2b":
                    trainer = new Trainer();
                    saveTrainer(trainer, Constants.SAVE_FILE_2);
                    break;
                case "2c":
                    trainer = new Trainer();
                    saveTrainer(trainer, Constants.SAVE_FILE_3);
                    break;
                case "3":
                    System.exit(0);
            }
            ...
            if(trainer == null){
                System.out.println("You haven't create a trainer yet.");
                nameSet = false;
            }
        }
            ...
            switch(input){
                ...
                case "4d":
                    if(getSaveFileStatus(Constants.SAVE_FILE_1).equals("empty")){
                        ...
                        System.out.println("You have no place to store your progressing.");
                    }
                    System.exit(0);
                case "5":
                    if(curCity.getName().equals("Saffron City")){
